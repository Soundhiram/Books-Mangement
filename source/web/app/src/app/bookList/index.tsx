...
const ListBook: React.FC = () => {
    ...
    const fetchBooks = async () => {
        try {
            setLoading(true);
            const response = await axios.get<Book[]>('http://localhost:3333/api/book/books');
    ...
    const handleSave = async () => {
        try {
            ...
            setLoading(true);
            const response = await axios.put<Book>(`http://localhost:3333/api/book/book/${editedBook._id}`, editedBook);
                ...
                <Form layout="vertical">
                    <Form.Item label="Title">
                        <Input
                            ...
                            onChange={(e) => setEditedBook((prevEditedBook) => ({
                                ...prevEditedBook!,
